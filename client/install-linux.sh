...
if [ ! -f "$asset" ]; then
  curl -fL --proto '=https' --tlsv1.2 "https://github.com/thomaskien/t2med-sumup/releases/download/v1.0/$asset" -o "$asset"
  curl -fL --proto '=https' --tlsv1.2 'https://github.com/thomaskien/t2med-sumup/releases/download/v1.0/SHA256SUMS' -o SHA256SUMS
fi
