...
if (!(Test-Path $asset)) {
    Invoke-WebRequest "https://github.com/thomaskien/t2med-sumup/releases/download/v0.1/$asset" -OutFile $asset -UseBasicParsing
    Invoke-WebRequest 'https://github.com/thomaskien/t2med-sumup/releases/download/v0.1/SHA256SUMS' -OutFile SHA256SUMS -UseBasicParsing
}
